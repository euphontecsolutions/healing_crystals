...
// attributes
    ...
    function add_cart($products_id, $qty = '1', $attributes = '', $notify = true,$price) {
...
// insert into database
        if (tep_session_is_registered('customer_id')){ 
            if(tep_session_is_registered('is_retail_store')){
                tep_db_query("insert into " . TABLE_CUSTOMERS_BASKET . " (customers_id, products_id, customers_basket_quantity, customers_basket_date_added, from_retail, app_added_price) values ('" . (int)$customer_id . "', '" . tep_db_input($products_id) . "', '" . $qty . "', '" . date('Ymd') . "', '1', '" . $price . "')");
            }else{
                tep_db_query("insert into " . TABLE_CUSTOMERS_BASKET . " (customers_id, products_id, customers_basket_quantity, customers_basket_date_added, app_added_price) values ('" . (int)$customer_id . "', '" . tep_db_input($products_id) . "', '" . $qty . "', '" . date('Ymd') . "', '" . $price . "')");
            }
        }
