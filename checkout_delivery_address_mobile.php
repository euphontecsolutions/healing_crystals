<?php
/*
  $Id: checkout_shipping_address.php,v 1.2 2003/09/24 15:34:25 wilt Exp $
...
<Address2>'.$street_address.'</Address2><City>'.$city.'</City><State>'.$state.'</State><Zip5>'.$postcode.'</Zip5><Zip4></Zip4></Address></AddressValidateRequest>';
        ...
        $http = new httpClient();               
                 ...
                 if (preg_match('/<Error>/', $respBody)) {
                    $error = true;
                    $messageStack->add('checkout_address','Your address failed USPS Adrress Verification, Please enter correct Address');
                }
    }
...
// process the selected shipping destination
      ...
      $_SESSION['cart_address_id'] = $HTTP_POST_VARS['address'];
...
// if no shipping destination address was selected, use their own address as default
  ...
  $content = 'checkout_delivery_address_mobile.php';
