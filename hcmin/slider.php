            ...
            <td valign="top"><table border="0" width="100%" cellspacing="2" cellpadding="2">
              <tr class="dataTableHeadingRow">
               <?php //if($HTTP_GET_VARS['sort'] == 'ASC'){$new_sort = 'DESC';}else{$new_sort = 'ASC';}?>
                ...
                <td class="dataTableHeadingContent">slider image</td>
                <td class="dataTableHeadingContent">content text</td>
...
?>
              <tr>
                <td align="right" colspan="2" class="smallText"><?php echo '<a href="' . tep_href_link('slider_add.php') . '">' . tep_image_button('button_insert.gif', IMAGE_INSERT) . '</a>'; ?></td>
              </tr>
<?php
  }
?>
