...
{
	$v=$_POST['imgedt1'];
	 $edit1 =tep_db_query("select * from info_slider where id='".$v."'");
	 $edit_array = tep_db_fetch_array($edit1);
	 unlink("images/". $edit_array['file_name']);
	}
else
{
...
<div class="csk">
             ...
             <form action="slider_update_image.php" method="POST" enctype="multipart/form-data">
    <?php
   /* include("ckeditor/ckeditor.php");
    $CKeditor = new CKeditor();
    $CKeditor->BasePath = 'ckeditor/';
    $CKeditor->editor('editor1',$edit_array['content']);*/
...
<input type="file" name="file">
   <input type="hidden" name="updateid" value="<?php echo $edit_array['id']?>">
