...
if(isset($_POST["update"]) && !empty($_FILES["file"]["name"])){
    ...
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
            ...
            tep_db_query("update info_slider set file_name='".$fileName."' where id='".$v."'");
...
if(isset($_POST["update"]))
{
	...
	$c=$_POST['editor2'];
	 ...
	 $update =tep_db_query("update info_slider set content='".$v."' where id='".$v."'");
	 $update_array = tep_db_fetch_array($update);
...
<div class="csk">
             ...
             <form action="slider_load.php" method="POST" enctype="multipart/form-data">
         <?php
