...
select{
 ...
 <div class="container">
    <?php echo tep_draw_form('checkout_address', tep_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS_MOBI, '', 'SSL'), 'post', ' class="" style="background-color:transparent;" onSubmit="return check_form_optional(checkout_address);"'); ?>
...
// EOF: Lango Added for template MOD
?><div class="row"><table border="0" width="100%" cellspacing="1"  class="">
          <tr class="">
            <td><table border="0" width="100%" cellspacing="0" >
              <tr>
          <!--       <td class="main"><?php echo '<b>' . TITLE_CONTINUE_CHECKOUT_PROCEDURE . '</b><br>' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></td> -->
                <td class="main" >
                 ...
                 <center><button class="btn btn-success btn-block" type="submit"><?php echo IMAGE_BUTTON_CONTINUE; ?></button></center>
