...
<?php
        ...
        ?>
<link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Cooper Black">
		...
		elseif (basename($PHP_SELF) == 'products1.php') {
            ...
            echo '<link rel="canonical" href="' . tep_href_link('article_info.php', 'articles_id=' . $HTTP_GET_VARS['articles_id']) . '">';
               ...
               if (basename($PHP_SELF) == 'subscribe.php' || basename($PHP_SELF) == 'rewards_subscribe.php'){
                    ?>
<link rel="stylesheet" type="text/css" href="<?=STATIC_URL?>templates/mobile_template/stylesheet_subs.css">
<?php
                }elseif (basename($PHP_SELF) == 'products.php' && $_GET['category'] == 'C'){ ?>
<link rel="stylesheet" type="text/css" href="<?=STATIC_URL?>templates/mobile_template/stylesheet_latest.css">
<?php
