...
$(document).ready(function(){
	...
	$(".sub_togle0").click(function(){
        $(".sub_toggle_list0").toggle();
    });
	$(".sub_togle1").click(function(){
        $(".sub_toggle_list1").toggle();
    });
	$(".sub_togle2").click(function(){
        $(".sub_toggle_list2").toggle();
    });
	$(".sub_togle3").click(function(){
        $(".sub_toggle_list3").toggle();
    });
	$(".sub_togle4").click(function(){
        $(".sub_toggle_list4").toggle();
    });
	$(".sub_togle5").click(function(){
        $(".sub_toggle_list5").toggle();
    });
	$(".sub_togle6").click(function(){
        $(".sub_toggle_list6").toggle();
    });
...
<tr>
	<td align="center" class="backgroundgradient"><table class="wrapper" style="background:none;" cellpadding="0" cellspacing="0" border="0"  align="left" width="100%">
		<tr>
			<!--                <td  align="left" style=" width:10%; max-width:10%;" class="backgroundgradientcolorlefttoright" >
                    &nbsp;
                </td>-->
			<td align="left" style=" width:80%; max-width: <?php echo SITE_WIDTH; ?>; "><table align="center" class="maintable" style="max-width: <?php echo SITE_WIDTH - 10; ?>; " cellspacing="0" cellpadding="0" BORDER="0" width="<?php echo SITE_WIDTH; ?>" >
				<tr>
					<td align="left"  width="100%"><table align="left" border="0" width="100%" style="max-width: <?php echo SITE_WIDTH - 10; ?>; " cellpadding="0" cellspacing="0">
						<tr>
							<td><?php } ?>
								...
								<table cellspacing="0" cellpadding="0" width="100%" border="0">
									<tr>
										<td align="center" width="100%"><?php echo $pageTemplateArray['page_and_email_templates_content']; ?></td>
									</tr>
								</table>
								<?php
										}
								...
								<table cellspacing="0" align="center" cellpadding="0" width="100%"  border="0" >
									<tbody>
										<tr>
											<td><table class="table-main" cellspacing="0"  border="0"  cellpadding="0" width="100%" align="center">
													<tr>
														<td class="TDw100"><table width="100%" cellspacing="0" cellpadding="0">
																<tr>
																	<td valign="top" class="text-center"><a href="index.php"><img src="templates/New4/images/header/mandala_122x120.png" style="width: 100px; " alt=""> </a></td>
																</tr>
															</table></td>
														<td class="TDw100"><table width="100%" cellspacing="0" cellpadding="0" align="right" >
																<tr>
																	<td class="TDw100 pd0" colspan="2" style="padding-left:65px;" ><table align="center" cellspacing="0" cellpadding="0" class ="textleft" id="wrapper">
																			<tr>
																				<?php if (tep_session_is_registered('customer_id')) {?>
                                       <!--<td valign="bottom" style="font-size:13px; padding-bottom:2px;"><a  style="color:#000000;" href="<?php echo HTTPS_SERVER_SSL."/account.php"; ?>"> Account</a> /<a  style="color:#000000;" href="<?php echo HTTPS_SERVER_SSL."/logoff.php"; ?>"> Sign Out</a>&nbsp;&nbsp;&nbsp;|</td>-->
																				...
																				<?php }else{ ?>
                                        <!--<td valign="bottom" style="font-size:13px; padding-bottom:2px; "><a  style="color:#000000; " href="<?php echo HTTPS_SERVER_SSL."/login.php"; ?>">Account / Sign In&nbsp;&nbsp;&nbsp;|</a></td>-->
																				...
																				<td valign="bottom" style="font-size:13px; padding-bottom:3px;"><a style="color:#000000;" href="<?php echo tep_href_link("contact_us.php"); ?>">&nbsp;&nbsp;&nbsp;Contact Us&nbsp;&nbsp;&nbsp;</a></td>
																			</tr>
																	...
																	<td class="TDw100 text-center"><table cellspacing="0" cellpadding="0" class ="header-cart" id="wrapper">
																			<tr>
																				<td style="font-size:13px;"><table id="mini-bag-table" width="100%" style=" background: url('templates/New4/images/header/shopping_button.png') no-repeat;  background-size:cover; width:227px; height: 28px;" cellspacing="0" cellpadding="0">
																						<tr>
																							<td onmouseout="shoppingbagHide()" onmouseover="shoppingbagShow();" style="height:28px; width:144px;"><a style="color:#14116c;" href="<?php echo tep_href_link("shopping_cart.php"); ?>">
																								<div  style=" margin-left:124px; ">(<?php echo $cart->count_contents(); ?>)</div>
																								</a></td>
																							<td><a style="color:#14116c;" href="<?php echo tep_href_link("checkout_payment.php", '', 'SSL'); ?>">
																								<div>&nbsp;</div>
																								</a></td>
																							<div onmouseout="shoppingbagHide()" onmouseover="shoppingbagShow();"  class="mini-bag-section" id="mini-bag-section" styl="display:none;">
																								<div onmouseover="shoppingbagShow();"  class="mini-bag-section-content clearfix">
																									<div onmouseover="shoppingbagShow();"  class="mini-bag-section-content-top">
																										...
																										<a title="Close" href="#" name="Close - Mini" class="ir sprite sprite-close" id="mini-bag-close" onclick="shoppingbagHide(); return false;">X</a> </div>
																									<div onmouseover="shoppingbagShow();"   class="mini-bag-section-content-scroll">
																										<ul class="clearfix">
																											<li class="mini-bag-item empty-item">
																												<div >
																													<?php if($cart->count_contents()>0){ echo 'Items:'. $cart->count_contents().
'<br/> Total Amount : $' . $cart->show_total();} else{ echo 'There are currently no items in your Shopping Bag.';  } ?>
																												</div>
																											</li>
																										</ul>
																									</div>
                                    ...
                                    <tr>
                                             <td valign="top"><a href="http://copy.healingcrystals.com"><img src="templates/New4/images/header/mandala1.jpg" style="width: 120px; " alt="">   </a></td></tr>
																				...
																				<td class="TDw100" width="70%" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
																						<tr>
																							<td class="TDw100 text-center" valign="top" align="right"><a href="index.php" class="logoHC"><img src="templates/New4/images/header/text_logo_540x75.png"  onmouseover="tooltip.show();" onmouseout="tooltip.hide();" style="width: 540px; padding-left:30px;" alt=""> </a></td>
																						</tr>
																						<!--                                    <tr>
                                             <td valign="top" align="center"><img src="templates/New4/images/header/tag_line.jpg" style="width: 485px; " alt=""></td></tr>-->

																					</table></td>
																				<td class="TDw100" width="30%" valign="bottom" ><form NAME="quick_find" ACTION="<?php echo tep_href_link("advanced_search_result.php"); ?>" METHOD="get"  id="auto_off">
																						<table cellspacing="0"  border="0"  cellpadding="0" width="100%">
																							<tr align="center" >
																								<td style=" padding-left:70px; height:27px; z-index:999;" class="pd0"><table cellspacing="0" cellpadding="0" border="0" id="menu1" style=" background: url('templates/New4/images/header/searchbar_225x31.png') no-repeat;  width:225px; height:31px;">
																										<tr>
																											<td valign="top"><div class="glossymenuHeader" style="float: left; display: inline; "> <a href="javascript:void(0);" onclick="document.quick_find.submit();">
																													<div style=" height: 25px; width: 21px;">&nbsp;</div>
																													</a> </div>
																												<div  valign="bottom" align="center" nowrap >
																													...
																													<INPUT type="text" maxLength="30" style="width:153px; font-size: 14px; color:#000000; background: transparent; outline:none;border:0px none; height: 17px; padding:8px; padding-bottom:4px;" id="ya" name="keywords" value="Search Products..." onclick="if(this.value=='Search Products...' || this.value=='Search Articles...' || this.value=='Search MPD...' ){this.value=''}" onblur="if(this.value==''){this.value=$('#searchtextDD').val();}">
																													<br>
																													<div id="box_search"></div>
																												</div></td>
																											<td valign="bottom" align="left" ><div style=" width:20px; cursor: default;float: left;height:23px; "><a onclick="searchddshow = true;" href="javascript:void(0);" style="text-decoration:none;">
																													<div style="padding: 1px; height: 25px; width: 20px;">&nbsp;</div>
																													</a> </div></td>
																										</tr>
																									</table></td>
																							</tr>
																							<tr>
																								<td class="text-center pd0 " style="padding-right: 132px;" valign="top"><table cellspacing="0" cellpadding="0" border="0" class="hsearch-drop">
																										<tr>
																											<td><div style="position: absolute; width: 225px; overflow: hidden; margin-left: -94px; margin-top:-13px; z-index:99;">
																							...
																							<tr>
																								<td width="100%" colspan="3" align="left" valign="middle"  style="cursor:pointer; vertical-align:middle; height:38px;z-index:9; Padding-left:73px;" class="TDw100 text-center pd0"><div id="demo">
																										<marquee style="width:220px;" class="w100">
																										<?php echo implode('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',$rotating_array); ?>
																										</marquee>
																									</div></td>
																							</tr>
																						</table>
													...
													<tr>
                                                       ...
                                                       <div class="main_nav_bar">
                                                        ...
                                                        <span></span>
                                                        <span></span></button>
                                                        <ul class="topnav" id="myTopnav" style="font-weight: bold; font-size:14px;">
																<li><div class="community">
																			<ul>
																				<li style=" width:136px;"> <a style="color:#000000;" href="<?=tep_href_link('catalog.html');?>">Catalog & Specials</a><span class="sub_togle0 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list0 sub_toggle_list">
																						...
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("catalog.html"); ?>">Catalog</a></li>
																...
																<li><div class="community"><ul>
																				<li style="width:111px; height:18px;"> <a style="color:#000000; " href="<?=tep_href_link('products.php','category=J&amp;show=shape');?>"> Crystal Jewelry </a> <span class="sub_togle1 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list1 sub_toggle_list">
																						...
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("crystal-jewelry-by-stone.html"); ?>">By Stone types</a></li>
																					</ul>
																				</li>
																			</ul></div></li>
																<li><div class="community"><ul>
																				<li style="width:110px; height:18px;"> <a style="color:#000000; " href="<?=tep_href_link('products.php','category=C&amp;show=shape');?>">Cut & Polished</a><span class="sub_togle2 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list2 sub_toggle_list">
																						...
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("cut-and-polished-crystals-by-wands-shape.html"); ?>">Wands</a></li>
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("cut-and-polished-crystals-by-shape.html"); ?>">By Shape</a></li>
																...
																<li><div class="community"><ul>
																				<li style=" width:196px; height:18px;"> <a style="color:#000000;" href="<?=tep_href_link('products.php','category=N&amp;show=shape');?>">Natural Crystals & Minerals</a> <span class="sub_togle3 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list3 sub_toggle_list">
																...
																<li><div class="community"><ul>
																				<li style="width:117px; height:18px;"> <a style="color:#000000; " href="<?=tep_href_link('products.php','category=T&amp;show=stone');?>">Tumbled Stones</a>
                                                                                <span class="sub_togle4 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list4 sub_toggle_list">
																...
																<li><div class="community"><ul>
																				<li style="width:78px; height:18px;"><a style="color:#000000; " href="<?php echo tep_href_link("Facebook__Twitter__Pinterest_and_more_Social_Media_Sites_Articles_2793.html"); ?>">Community</a><span class="sub_togle5 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list5 sub_toggle_list">
																...
																<li><div class="community"><ul>
																				<li style="width:126px; height:18px;"><a style="color:#000000;" href="<?=tep_href_link('Metaphysical_Directory_Crystal_Guide_Topics_3.html');?>">Metaphysical Info</a><span class=" sub_togle6 sub_togle"><img width="13" height="13" border="0" src="<?=STATIC_URL?>templates/New4/images/arrow_down.gif"></span>
																					<ul class="sub_toggle_list6 sub_toggle_list">
																						...
																						<li><a style="font-size:14px; color:#000000; font-weight:bold"href="<?php echo tep_href_link("Crystals_for_Common_Conditions_Articles_12069.html"); ?>">Common Conditions</a></li>
                                            <li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("cards.php"); ?>">Crystal Divination Cards</a></li>
																						...
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("quotes-welcome.html"); ?>">Inspirational Quotes</a></li>
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("Metaphysical_Directory_Crystal_Guide_Topics_3.html"); ?>">Metaphysical Directory</a></li>
																						<li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("References-and-Resources-Guide.html"); ?>">References & Resources</a></li>
                                            <li><a style="font-size:14px; color:#000000; font-weight:bold" href="<?php echo tep_href_link("sessions-and-class.html"); ?>">Sessions & Classes</a></li>
																					</ul>
																				</li>
																			</ul></div></li>
															...
															<table  width="100%" cellspacing="0" cellpadding="0">
																<tr>
																	<td ></td>
																	<td style="font-weight: bold; font-size:15px; padding-right:22px;"><div class="community">
																	...
																	<td  style="font-weight: bold; font-size:15px; padding-right:17px;"><div class="metaphysical">
