...
<html <?php echo HTML_PARAMS; ?>>
    ...
    ?>
        ...
        <style>#showLeftMenuButton img{ display:none;}</style>
    </head>
    <body <?php
...
// Hide column_left.php if not to show
          ...
          <table id="leftmenubutton" cellSpacing=0 width=0  border=0 style="border-collapse: collapse; display:<?php echo $tbl_left_style ?>;" cellpadding="0">
                        <?php 
