            ...
            <ul  class="left_toggle_list7 left_nav_listU">
				...
				<!--EOF:mod 20110920 #400 -->
                                ...
                                <ul class="left_toggle_list9 left_nav_listU">
                                                ...
                                                <li onmouseover="document.ge`tElementById('twentythree-ddheader').style.background='#81A5FF'"><a href="<?php echo tep_href_link("taglist.php", "show=stone_property&amp;p_id=12"); ?>">Chakra (Secondary)</a></li>
		...
		<tr>
                    ...
                    <div class="glossymenuHeader"><a class="menuitem submenuleftheader" href="javascript:void(0);">Metaphysical Guides</a>
                        <div class="submenuleft">
							<table class="submenuAff" cellpadding="0" cellspacing="0" width="100%">
								...
								<tr>
									<td>
										<a href="<?= tep_href_link('Crystals_for_Common_Conditions_Articles_12069.html'); ?>">Common Conditions</a>
									</td>
								</tr>
							</table>
						</div>
			...
			<tr>
                <td valign="bottom">
                    <div class="glossymenuHeader"><a class="menuitem submenuleftheader" href="javascript:void(0);">Articles &amp; Fun</a>
                        <div class="submenuleft">
                            ...
                            <ul>
                                <li  class="left_menu_li">
                      <a href="http://www.healingcrystals.com/References-and-Resources-Guide.html">References & Resources</a>
                ...
                <a href="/contests.html">Contests & Games</a>
								...
								<li class="left_menu_li">
                                <a href="/Book_Reviews_Topics_27.html">Book Reviews</a>
