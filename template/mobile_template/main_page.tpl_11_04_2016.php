...
// Hide column_left.php if not to show
					...
					//$visible = 'none';
                        ...
                        //if (!isset($HTTP_GET_VARS['image'])){
                ?>
                       <td class="leftNav"  width="<?php //echo BOX_WIDTH_LEFT; ?>" valign="top" id="columnLeft" >
                            <table id="leftmenubutton" cellSpacing=0 width=0  border=0 style="border-collapse: collapse; display:none;" cellpadding="0">
                        <?php 
...
//                            }
                           ...
                           { ?>
                            ...
                            <tr><td align="center"><img onClick="$('#leftmenubutton').toggle();$('#showLeftMenuButton').toggle();" src="images/left_menu_button_hide.png" style="width:112px; height:25px;"> </td></tr>
                               <?php
                                require(DIR_WS_INCLUDES . 'column_left.php'); 
                            }    ?>
				...
				*/
                ...
                if(basename($PHP_SELF) == 'grading_summary.php'){
                    ?>
                <td width="80%" valign="top" id="mainContentTD">

                    <?php if($HTTP_GET_VARS['screenshot_preview']!='1')
                    { 
			...
			?>					
                ...
                <td width="100%" valign="top" id="mainContentTD">
